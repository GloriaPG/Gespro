<%-- 
    Document   : report_caducidad_list
    Created on : 9/09/2016, 10:08:58 AM
    Author     : DXN
--%>
                ...
                <div class="inner">
                    ...
                    <div class="onecolumn">
                        ...
                        <div class="content" style="display: none;">
                            <form action="report_caducidad_list.jsp" id="search_form_advance" name="search_form_advance" method="post">
                                <p>
                                    Por Fecha &raquo;&nbsp;&nbsp;
                                    <label>Desde:</label>
                                ...
                                <select id="q_idpromoto" name="q_idpromotor" class="flexselect">
                                    <option></option>
                    ...
                    <div class="onecolumn">
                        ...
                        <div class="content">
                            ...
                            <!-- FIN INCLUDE OPCIONES DE EXPORTACIÓN-->
                             <jsp:include page="../include/reportExportOptions.jsp" flush="true">
                                <jsp:param name="idReport" value="<%= ReportBO.CADUCIDAD_REPORT %>" />
                                <jsp:param name="parametrosCustom" value="<%= filtroBusquedaEncoded %>" />
                            </jsp:include>                            
