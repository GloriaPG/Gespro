<%-- 
    Document   : report_competencia_list
    Created on : 9/09/2016, 10:11:27 AM
    Author     : DXN
--%>
                ...
                <div class="inner">
                    ...
                    <div class="onecolumn">
                        ...
                        <div class="content" style="display: none;">
                            <form action="report_competencia_list.jsp" id="search_form_advance" name="search_form_advance" method="post">
                                <p>
                                    Por Fecha &raquo;&nbsp;&nbsp;
                                    <label>Desde:</label>
                    ...
                    <div class="onecolumn">
                        ...
                        <div class="content">
                                ...
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <%
                                                String competencias = "";
                                                EstanteriaDescripcion[] estanteriaDesc = new EstanteriaDescripcionBO(user.getConn()).findEstanteriaDescripcions(0, item.getIdEstanteria(), 0, 0, 0, "");
                                                for(EstanteriaDescripcion estanteriaDescripcion : estanteriaDesc){
                                                    Competencia competencia = new CompetenciaBO(user.getConn()).findMarcabyId(estanteriaDescripcion.getIdCompetencia());
                                                    
                                                       competencias += competencia.getNombre()+": "+estanteriaDescripcion.getPrecio()+","; 
                                                    
                                                }
                                            %>
                                            <td><%=competencias!=""? (competencias) :"Sin competencias" %></td>
                            ...
                            <!-- FIN INCLUDE OPCIONES DE EXPORTACIÓN-->
                             <jsp:include page="../include/reportExportOptions.jsp" flush="true">
                                <jsp:param name="idReport" value="<%= ReportBO.COMPETENCIA_REPORT %>" />
                                <jsp:param name="parametrosCustom" value="<%= filtroBusquedaEncoded %>" />
                            </jsp:include>                            
