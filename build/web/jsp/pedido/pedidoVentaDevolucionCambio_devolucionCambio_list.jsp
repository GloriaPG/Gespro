                                    ...
                                    <tbody>
                                        <% 
                                            for (SgfensPedidoDevolucionCambio item:sgfensPedidoDevolucionCambiosDto){
                                                try{
                                                    Usuarios emp = null;
                                                    DatosUsuario dUsuario = null;
                                                    String nombreUsuarios = "";
                                                    try{
                                                    emp = new UsuariosBO(item.getIdEmpleado(), user.getConn()).getUsuario();                                                    
                                                    dUsuario = new DatosUsuarioBO(emp.getIdDatosUsuario(), user.getConn()).getDatosUsuario();
                                                    nombreUsuarios = dUsuario.getNombre() + " " + dUsuario.getApellidoPat() + " " + dUsuario.getApellidoMat();
                                                    }catch(Exception e){}
