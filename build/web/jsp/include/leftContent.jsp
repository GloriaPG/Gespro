...
<div id="left_menu">
    ...
    <ul id="main_menu">        
        ...
        <li>
            <a href="" id="idProyectosLeftContent"><img src="../../images/icon_validaXML.png" alt="Proyectos"/>Proyectos</a>
            <ul>
                <li><a href="../../jsp/catProyectos/catProyectos.jsp" id="idCatalogoProyectos" ><img src="../../images/icon_validaXML.png"/>Ver Proyectos</a></li>
                <li><a href="../../jsp/catCoberturas/catCoberturas_list.jsp" id="idlistaCoberturas"><img src="../../images/camion_icono_16.png"/>Cobertura</a></li>
            </ul>	
        </li>
