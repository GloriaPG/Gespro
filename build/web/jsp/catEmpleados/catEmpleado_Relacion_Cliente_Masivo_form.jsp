<%-- 
    Document   : catEmpleado_Relacion_Cliente_Masivo_form
    Created on : 11/03/2016, 06:20:41 PM
    Author     : leonardo
--%>
                        ...
                        success: function(datos){
                            if(datos.indexOf("--EXITO-->", 0)>0){
                               ...
                               apprise('<center><img src=../../images/info.png> <br/>'+ datos +'</center>',{'animate':true},
                                        function(r){
                                            location.href = "../catClientes/catClientes_list.jsp?pagina=<%=paginaActual%>";
                                        });
                           }else{
                               $("#ajax_loading").fadeOut("slow");
                               $("#ajax_message").html(datos);
                    ...
                    <div class="twocolumn">
                        <div class="column_left">
                            ...
                            <div class="content">
                                    ...
                                    <input type="hidden" id="idsClientes" name="idsClientes" value="<%=idsClientes%>"/>
                                    <input type="hidden" id="conservarAsignacion" name="conservarAsignacion" value="<%=conservarAsignacion%>"/>
