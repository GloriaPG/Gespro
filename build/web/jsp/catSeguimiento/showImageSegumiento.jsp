...
<%
    ...
    try{
         ...
         String ubicacionImagenesSegumiento = appConfig.getApp_content_path() + rfcEmpresaMatriz +"/seguimiento/";
         
         String archivoImagen= ubicacionImagenesSegumiento+fileName;
