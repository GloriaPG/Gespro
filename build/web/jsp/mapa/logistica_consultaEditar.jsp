...
<%@page import="com.tsp.gespro.factory.TipoRutaDaoFactory"%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{            
        promotorDto = UsuariosDaoFactory.create(user.getConn()).findByPrimaryKey(rutaDto.getIdUsuario());
    }catch(Exception e){
                                ...
                                <div class="content">
                                    <form id="form_nueva_ruta" name="form_nueva_ruta" action="" method="post">
                                        ...
                                        <p>
                                            ...
                                            <input maxlength="100" type="text" id="txt_nombre_ruta" name="txt_nombre_ruta" style="width:300px;" value="<%=rutaDto!=null?rutaDto.getNombreRuta():"" %>"/>
                                        </p>
                                        <br/>
                                        <p>
                                            <label>*Comentarios:</label><br/>
                                            <textarea id="txt_comentario_ruta" name="txt_comentario_ruta" cols="40" rows="3" style="" ><%=rutaDto!=null?rutaDto.getComentarioRuta():"" %></textarea>
                                        </p>
                                        <br/>
                                        <p>
                                    ...
                                    <form id="form_mapa_buscador" name="form_mapa_buscador" action="" method="post">
                                        <p id="p_promotor_busqueda" style="display: none;">
                                            ...
                                            <select id="cmb_promotor_buscar" name="cmb_promotor_buscar">
                                                ...
                                                <%
                                                Usuarios[] empleadosDto = new UsuariosBO(user.getConn()).findUsuariosByRol(idEmpresa, RolesBO.ROL_GESPRO);
                                                for(Usuarios empleadoDto : empleadosDto){
                                                    ...
                                                    out.print("<option value=\""+empleadoDto.getIdUsuarios()+"\">"+datosUsuarioDto.getApellidoPat() + (datosUsuarioDto.getApellidoMat()!=null?" " + datosUsuarioDto.getApellidoMat():"") + " " + datosUsuarioDto.getNombre()+"</option>");
                                                }
                                                %>
                                            </select>
