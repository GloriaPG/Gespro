...
<%
    ...
    if (mode.equals("2")) { //SI ES 2 ES PARA BORRAR
        ...
        contrasenaEmpleado = request.getParameter("password") != null ? new String(request.getParameter("password").getBytes("ISO-8859-1"), "UTF-8") : "";
        ...
        if(!gc.isValidString(usuarioEmpleado, 5, 30) && (mode.equals(""))){
            msgError += "<ul>El dato 'Usuario' no es válido, al menos 5 caracteres, máximo 30.";
        }
        if(contrasenaEmpleado.equals("") && (mode.equals(""))){
        ...
        if (mode.equals("1")) {
            ...
            System.out.println("----1--: " + usuarioActualizarDto.getUserName());
            System.out.println("----2--: " + usuarioEmpleado);
